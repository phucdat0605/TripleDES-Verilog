...
## 📌 Project Overview (Tổng quan Đồ án)
...
## 📐 Architecture & Data Path (Kiến trúc Hệ thống)
...
## 📊 Synthesis & Performance Metrics (Kết quả Thực nghiệm)
...
│   ├── tripleDES.v         # Top-level entity integrating Encrypt & Decrypt
│   ├── tdes_encrypt.v      # Pipelined 3DES Encryption Core
│   ├── tdes_decrypt.v      # Pipelined 3DES Decryption Core
│   ├── des_encrypt.v       # Single DES Encryption Core (16 Feistel Rounds)
│   └── des_decrypt.v       # Single DES Decryption Core
├── sim/                    # Simulation and Testbenches
│   ├── tb_tripleDES.v      # Full verification environment for Top-level System
│   └── wave_sample.png     # Waveform capture proving 100% data recovery
└── README.md
>>>>>>> a795984 (First commit)
